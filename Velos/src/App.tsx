...
const ProcessGroupsPage = lazy(() => import('./modules/process-groups/ProcessGroupsPage'));
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/dashboard" element={<AppLayout />}>
          ...
          <Route path="process-groups" element={
            <Suspense fallback={null}><ProcessGroupsPage /></Suspense>
          } />
          <Route path="processes" element={
            <Suspense fallback={null}><ProcessesPage /></Suspense>
          } />
