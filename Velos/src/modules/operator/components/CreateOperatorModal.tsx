            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              ...
              <div
                style={{
                  ...
                  height: "56px",
                  borderRadius: "50%",
                  background: logoPreview ? "transparent" : "var(--app-border-subtle)",
              ...
              >
                {logoPreview ? (
                  ...
                  <span style={{ fontSize: "0.7rem", color: "var(--app-text-faint)", textAlign: "center" }}>Logo</span>
                )}
              </div>
              <div style={{ flex: 1 }}>
                <input
                ...
                />
                <span style={{ fontSize: "0.75rem", color: "var(--app-text-faint)", marginTop: "4px", display: "block" }}>
