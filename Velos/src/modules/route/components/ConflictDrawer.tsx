  ...
  return (
    <>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
        <div style={{ fontWeight: 800, fontSize: 16, color: 'var(--app-text)' }}>Reservation Details</div>
      ...
      <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', marginBottom: 12 }}>
        ...
        <span style={pill('var(--app-text-muted)', 'var(--app-border-subtle)')}>{reservation.lockType || '—'}</span>
