            ...
            return (
              <div
                ...
                style={{
                  ...
                  fontSize: 12,
                  fontWeight: 700,
                  color: active ? '#2563EB' : done ? '#065F46' : '#64748B',
                  borderBottom: `2px solid ${active ? '#2563EB' : done ? '#10B981' : 'transparent'}`,
          ...
          {step === 0 && (
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
              ...
              <div style={{ gridColumn: '1 / -1', display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                />
                <label htmlFor="bidir" style={{ fontSize: 13, color: '#0F172A', fontWeight: 600 }}>
                  Bidirectional route
                </label>
              </div>
            </div>
