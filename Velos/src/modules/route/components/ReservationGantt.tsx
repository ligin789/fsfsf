...
const colorFor = (r: CorridorReservationResponse) => {
  ...
  if (r.reservationStatus === 'CANCELLED') return { fill: 'var(--app-border-subtle)', border: 'var(--app-border)', text: 'var(--app-text-subtle)' };
  if (r.lockType === 'HARD_LOCK' || r.reservationStatus === 'CONFIRMED')
    return { fill: '#DBEAFE', border: 'var(--app-primary)', text: '#1E3A8A' };
  // soft lock
  return { fill: 'var(--app-border)', border: 'var(--app-text-faint)', text: 'var(--app-text-strong)' };
};
    ...
    <div style={{ width: '100%', overflowX: 'auto' }}>
      <div style={{ minWidth: 800 }}>
        ...
        <div style={{ display: 'flex', borderBottom: '1px solid var(--app-border)' }}>
          <div style={{ width: LABEL_W, padding: 8, fontSize: 11, fontWeight: 700, color: 'var(--app-text-subtle)' }}>
            CORRIDOR
          </div>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    top: 0,
                    bottom: 0,
                    borderLeft: '1px dashed var(--app-border)',
                    fontSize: 10,
        ...
        {corridors.map((c) => {
          ...
          return (
            <div key={c.corridorId} style={{ display: 'flex', borderBottom: '1px solid var(--app-border-subtle)' }}>
              <div
                style={{
                  width: LABEL_W,
                  padding: 10,
              ...
              >
                {c.corridorName}
                <div style={{ fontSize: 10, color: 'var(--app-text-faint)', fontWeight: 600 }}>
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        top: 0,
                        bottom: 0,
                        borderLeft: '1px dashed var(--app-border-subtle)',
                      }}
                    />
                  );
                })}
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        bottom: 6,
                        background: c.fill,
                        border: `2px solid ${active ? 'var(--app-text)' : c.border}`,
                        color: c.text,
                        borderRadius: 6,
                        padding: '2px 6px',
                        fontSize: 11,
