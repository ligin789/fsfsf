...
const defaultBadgeColor = (value: string): { color: string; bg: string } => {
  ...
  return { color: "var(--app-text-subtle)", bg: "rgba(100, 116, 139, 0.1)" };
};
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <HiOutlineSearch size={16} style={{ color: "var(--app-text-faint)", flexShrink: 0 }} />
          <input
            type="text"
        ...
        <div style={{ fontSize: "0.75rem", color: "var(--app-text-faint)", fontWeight: 500 }}>
      ...
      <div style={{ overflowX: "auto" }}>
        ...
        >
          <thead>
            <tr style={{ background: "var(--app-surface-subtle)", borderBottom: "1px solid var(--app-border)" }}>
              {columns.map((col) => (
                <th
                  key={col.key}
                  style={{
            ...
            {rows.length === 0 ? (
              ...
              rows.map((row) => (
                <tr
                  ...
                  onMouseEnter={(e) => ((e.currentTarget.style.background = "var(--app-surface-footer)"))}
