    ...
    return (
      <div className="d-flex align-items-center justify-content-center" style={{ minHeight: "400px" }}>
        <div className="text-center">
          <h2 style={{ fontSize: "1.5rem", fontWeight: 700, color: "#1E293B" }}>Vertiport Not Found</h2>
            ...
            <div className="row g-3">
              {capacityItems.map(({ label, value }) => (
                <div key={label} className="col-4 text-center">
                  ...
                  <div style={{ fontSize: "0.75rem", color: "#64748B", fontWeight: 500, marginTop: "2px" }}>{label}</div>
                </div>
              ))}
            </div>
          </motion.div>
